    ...
    en: [
      {
        id: "video1",
        thumbnail: "/projects/audit-img.jpg",
        title: "Piano Competition - International PIANO FESTIBAQ Festival",
        description: "First piano competition for pianists from the Coast and Colombia",
        duration: "1:30",
        link: "https://www.instagram.com/p/CyMjWzlr5v0/"
      },
      {
        id: "video2",
        thumbnail: "/projects/recital-img.jpg",
        title: "2025-1 Enrollment - Allegretto Salmo 150",
        description: "Discover your musical talent! Piano, Guitar, Drums, Singing and more",
        duration: "1:00",
        link: "https://www.instagram.com/reel/DEIQG8kJ6V2/"
      },
      {
        id: "video3",
        thumbnail: "/projects/casio-img.jpg",
        title: "CASIO Latin America - Official Sponsor",
        description: "Rewarding musical talent with CASIO Privia and CT-S1 keyboards",
        duration: "0:45",
        link: "https://www.instagram.com/reel/CzZI23ZuVeE/"
      }
    ]
    ...
    en: [
      {
        ...
        description: "Branding for Zentro music school",
        duration: "1:00",
        link: "https://www.instagram.com/p/CyMjWzlr5v0/"
      },
      {
        id: "graphic2",
        image: "/projects/pc-img.png",
        title: "Poder Ciudadano UI Kit",
        description: "UI Kit for Poder Ciudadano application",
        duration: "1:00",
        link: "https://www.instagram.com/reel/CzZI23ZuVeE/"
      },
      {
        ...
        image: "/projects/allegretto-figma.png",
        title: "Allegretto Figma",
        description: "Figma for Allegretto music school",
        duration: "1:00",
        link: "https://www.instagram.com/p/CyMjWzlr5v0/"
      }
    ]
    ...
    en: [
      {
        id: "social1",
        image: "/projects/IMG_0173.jpg",
        title: "Musical Recitals - Allegretto",
      },
      {
        id: "social2",
        image: "/projects/IMG_2057.jpg",
        title: "Institutional Musical Event",
        link: "https://www.instagram.com/reel/CzZI23ZuVeE/"
      },
    ]
  }

  const currentVideos = videos[language as keyof typeof videos]
  const currentGraphics = graphics[language as keyof typeof graphics]
  const currentSocial = social[language as keyof typeof social]
